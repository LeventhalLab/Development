...
doSave = true;
if doSetup
    of_zParams = openField_zParams(trialActograms4,px2mm);
end
...
report_extinguishTrials(trialActograms6,px2mm,of_zParams,20,30);
...
% zDist analysis
zDist5 = report_openField(trialActograms5,stimIDs5,powerList,px2mm,of_zParams,0);
saveFile = 'report_openField_5_0Hz';
run_saveFigs(figPath,saveFile,exts,doSave);
zDist1 = report_openField(trialActograms1,stimIDs1,powerList,px2mm,of_zParams,20);
saveFile = 'report_openField_1_20Hz';
run_saveFigs(figPath,saveFile,exts,doSave);
zDist2 = report_openField(trialActograms2,stimIDs2,powerList,px2mm,of_zParams,50);
saveFile = 'report_openField_2_50Hz';
run_saveFigs(figPath,saveFile,exts,doSave);
zDist3 = report_openField(trialActograms3,stimIDs3,powerList,px2mm,of_zParams,100);
